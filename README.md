...
- 팀 내의 협업을 원할 하게 하기 위해 이와 같이 코드컨벤션을 준수하였습니다.
  ...
  함수와 메서드는 한가지 기능만 수행하도록 작성하고, 재사용성과 유지보수성을 높이기 위해 각 함수나 메서드의 크기를 작게 유지하도록 노력했습니다.
...
- 저희 '당당히'는 브랜치로부터 분기된 피처 브랜치에서 작업하는 것을 중심으로 했습니다.
  ...
  그리고 피쳐브랜치에서 개발한 기능이 완료되면 메인 브랜치로 병합하였습니다.
  주기적인 메인 브랜치와의 merge를 통해 오류를 최소화 하고, 코드 변경을 빠르게 메인 브랜치로 반영햇습니다. 이를 통해 지속적인 통합을 실현하고 에러의 재빠른 대처가 가능했습니다.
