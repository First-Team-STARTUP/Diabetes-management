...
### [로그인 & 로그아웃]
- 로그인 : 회원 가입한 사용자만 로그인 가능합니다.
- 로그아웃 : 상단 고정바의 로그아웃 버튼을 클릭하면 로그아웃이 완료됩니다.
...
'당당히' 프로젝트는 다른 프로젝와 경연을 통해 1등 한 프로젝트입니다.
이번 프로젝트에서 UI 디자인을 100% 구현했습니다. UX조사와 리서치를 통해 사용자 인터페이스를 분석했다는 점에서 프로젝트의 성과를 크게 높였습니다. Spring 프레임워크의 워크플로우와 보안 설계에 대해 깊이 이해할 수 있었습니다. 각 클래스와 코드의 역할 및 필요성에 대한 인식을 통해 보다 효율적인 개발을 위해 고민했습니다.

프로젝트 진행 중 긴밀한 팀워크와 소통을 통해 GitHub에서의 협업이 원활하게 이루어졌습니다. 협업 도구를 통한 오류 관리 및 수정 작업이 효과적이었기 때문에 개발 과정에서 큰 장애가 없었습니다. 팀 내에서의 지속적인 피드백과 검토를 통해 협업 효율을 높였습니다.

향후 서비스 확장 계획으로는 모바일 앱 개발을 통해 사용자 접근성을 높이고 서비스의 편의성을 개선할 예정입니다. 이를 통해 사용자 경험을 향상시키고 더 많은 사용자에게 도달할 수 있습니다. 또한, Amazon EC2를 이용하여 서비스를 배포함으로써 실제 운영 환경에서의 성능과 안정성을 테스트할 계획입니다.

마지막으로, 유저 베타 테스트를 실시하여 서비스에 대한 실제 사용자의 반응과 필요를 파악하려고 합니다. 이를 통해 사용자의 요구를 정확히 이해하고, 이에 기반한 서비스 개선과 확장을 진행할 예정입니다. 단계적 접근 방식을 통해 서비스를 끊임없이 연구하고, 지속 가능한 서비스로 성장하겠습니다.
