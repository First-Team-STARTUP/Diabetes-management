...
public class BoardController {
    ...
    public String saveForm(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        ...
        // 가져온 사용자 정보를 이용하여 추가적인 동적 데이터 가져오기
        List<Board> boardList = boardService.getBoardGroups(userDetails.getUsername());
...
//    @PostMapping("/save")
//    public String save(@ModelAttribute BoardDTO boardDTO, @AuthenticationPrincipal UserDetails userDetails) {
//        // 현재 인증된 사용자의 정보를 가져옴
...
//
//        // BoardService를 사용하여 게시판 그룹 저장
//        boardService.save(boardDTO);
//
//        // 저장 후 다시 입력 폼으로 리다이렉트
//        return "redirect:/board/save";// 저장 후 다시 입력 폼으로 리다이렉트
//    }
